...
import com.bytepoets.sample.androidtesting.ui.transactions.TransactionsFragment
...
class TransactionsFragmentIntegrationTest {
    @Module
    ...
    @Test
    fun selectSecondEntryShouldOpenDetailDialog() {
        // GIVEN
        ...
        onView(withText(TRANSACTION_WITH_POSITIVE_AMOUNT.subject)).perform(click())

        // THEN
        onView(withText(TRANSACTION_WITH_POSITIVE_AMOUNT.toString()))
            .inRoot(isDialog())
    ...
    private fun whenLaunchTransactionsFragmentInDummyActivity() {
        ...
        launchFragmentInHiltContainer<TransactionsFragment>(fragmentArgs)
    }
